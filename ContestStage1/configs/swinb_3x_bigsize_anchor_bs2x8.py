...
datasetA = dict(
    type=dataset_type,
    ann_file='ContestStage1\\train\\annotations\\instances_train2017.json',
    img_prefix='ContestStage1\\train\\images',
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file='ContestStage1\\val\\annotations\\instances_val2017.json',
        img_prefix='ContestStage1\\val\\images',
        pipeline=test_pipeline))
